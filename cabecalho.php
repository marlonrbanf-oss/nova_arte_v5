...
<head>
  ...
  <link rel="stylesheet" type="text/html" href="//fonts.googleapis.com/css?family=Poppins:300,400,500">
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    if (!isset($_SESSION['nome_usuario'])) {
                      echo '<li class="rd-nav-item"><a class="rd-nav-link" href="' . $url_site . 'login.php">Login</a></li>';
                    } else {
